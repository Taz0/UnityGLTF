...
namespace UnityGLTF
{
	internal class AvatarUtils
	{
		...
		public static Dictionary<string, string> HumanSkeletonNames = new Dictionary<string, string>()
		{
			...
			{"columna.002", "Spine" },
			{"columna.003", "Chest"},
			{"columna.004", "UpperChest" },
			{"cuello", "Neck" },
			{"cabeza", "Head" },

			{"hombro.L", "LeftShoulder" },
			{"DEF-brazo.L", "LeftUpperArm" },
			{"antebrazo.L", "LeftLowerArm" },
			{"mano.L", "LeftHand" },
			{"Thumb1.L", "Left Thumb Proximal" },
			{"Thumb2.L", "Left Thumb Intermediate" },
			{"Thumb3.L", "Left Thumb Distal" },
			{"Pinky1.L", "Left Little Proximal" },
			{"Pinky2.L", "Left Little Intermediate" },
			{"Pinky3.L", "Left Little Distal" },
			{"Ring1.L", "Left Ring Proximal" },
			{"Ring2.L", "Left Ring Intermediate" },
			{"Ring3.L", "Left Ring Distal" },
			{"Middle1.L", "Left Middle Proximal" },
			{"Middle2.L", "Left Middle Intermediate" },
			{"Middle3.L", "Left Middle Distal" },
			{"Index1.L", "Left Index Proximal" },
			{"Index2.L", "Left Index Intermediate" },
			{"Index3.L", "Left Index Distal" },

			{"hombro.R", "RightShoulder" },
			{"DEF-brazo.R", "RightUpperArm" },
			{"antebrazo.R", "RightLowerArm" },
			{"mano.R", "RightHand" },
			{"Thumb1.R", "Right Thumb Proximal" },
			{"Thumb2.R", "Right Thumb Intermediate" },
			{"Thumb3.R", "Right Thumb Distal" },
			{"Pinky1.R", "Right Little Proximal" },
			{"Pinky2.R", "Right Little Intermediate" },
			{"Pinky3.R", "Right Little Distal" },
			{"Ring1.R", "Right Ring Proximal" },
			{"Ring2.R", "Right Ring Intermediate" },
			{"Ring3.R", "Right Ring Distal" },
			{"Middle1.R", "Right Middle Proximal" },
			{"Middle2.R", "Right Middle Intermediate" },
			{"Middle3.R", "Right Middle Distal" },
			{"Index1.R", "Right Index Proximal" },
			{"Index2.R", "Right Index Intermediate" },
			{"Index3.R", "Right Index Distal" },

			{"DEF-muslo.L", "LeftUpperLeg" },
			{"DEF-espinilla.L", "LeftLowerLeg" },
			{"DEF-pie.L", "LeftFoot" },
			{"DEF-dedos_pie.L", "LeftToes" },

			
			{"DEF-muslo.R", "RightUpperLeg" },
			{"DEF-espinilla.R", "RightLowerLeg" },
			{"DEF-pie.R", "RightFoot" },
			{"DEF-dedos_pie.R", "RightToes" },
		};
